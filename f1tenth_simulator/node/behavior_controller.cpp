...
private:
    ...
    std::string drive_control_key_char;
...
public:
    BehaviorController() {
        ...
        n.getParam("drive_control_mux_idx", drive_control_mux_idx);
        // ***Add mux index for new planner here***
        ...
        n.getParam("drive_control_button_idx", drive_control_button_idx);
        // ***Add button index for new planner here***
        ...
        n.getParam("drive_control_key_char", drive_control_key_char);
        // ***Add key char for new planner here***
    ...
    void joy_callback(const sensor_msgs::Joy & msg) {
        ...
        else if (msg.buttons[drive_control_button_idx]) {
         // new planner
         toggle_mux(drive_control_button_idx, "Controller");
        }
    ...
    void key_callback(const std_msgs::String & msg) {
        ...
        if (msg.data == drive_control_key_char) {
         // drive controller
         toggle_mux(drive_control_mux_idx, "Controller");
        }
        // ***Add new else if statement here for new planning method***
